 ...
 * @returns {undefined}
 */
window.flagAlertMessage = (mess, wasError, $txtCtrl, title = '')=>{
    const toastr = require("./hhkToastr");
...
window.dateRender = (data, type, format)=>{
...
window.openiframe = (src, width, height, title, buttons)=>{
...
window.getDialogWidth = (defaultWidth)=>{
...
window.hhkReportError = (message, infoArray)=>{
	$.ajax({
