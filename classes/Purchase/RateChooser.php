    ...
    public function createChangeRateMarkup(\PDO $dbh, VisitRs $vRs) {
        ...
        if ($this->isAllowed) {
            ...
            $rateTbl->addBodyTr(HTMLTable::makeTh(
                ...
                . HTMLTable::makeTd(HTMLSelector::generateMarkup(HTMLSelector::doOptionsMkup(Common::removeOptionGroups($rateCategories), $rateCat[0], FALSE), array('name'=>'selRateCategory', 'class'=>'hhk-feeskeys'))
...
//        }
    ...
    protected function createBasicChooserMarkup(\PDO $dbh, Reservation_1 $resv, $nites, $visitFeeTitle, $idRegistration) {
        ...
        $rateSel = $this->makeRateSelControl(
                HTMLSelector::generateMarkup(HTMLSelector::doOptionsMkup(Common::removeOptionGroups($rateCategories), $roomRateCategory, FALSE), $rateSelectorAttrs),
