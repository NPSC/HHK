            ...
            $mu .= HTMLTable::makeTd(
                    HTMLContainer::generateMarkup('ul'
                            ...
                            . HTMLContainer::generateMarkup('li',
                                    ...
                                    , array('class'=>'ui-widget-header ui-corner-all hhk-togAddr', 'id'=>$this->getRoleMember()->getIdPrefix().'toggleAddr', 'style'=>'display:inline-block;margin-left:5px;', 'title'=>'Open - Close Address Section'))
