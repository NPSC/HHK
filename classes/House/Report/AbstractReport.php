...
abstract class AbstractReport {
    ...
    public function generateFilterMarkup(bool $excelDownload = true){
        ...
        return HTMLContainer::generateMarkup("div",
                ...
                , array("method"=>"POST", "action"=>htmlspecialchars($_SERVER["PHP_SELF"]), "class"=>"rptFilterForm"))
    ...
    public function generateMarkup(string $outputType = "") {
        ...
        return HTMLContainer::generateMarkup('form', HTMLContainer::generateMarkup("div", $this->generateSummaryMkup() . $tbl->generateMarkup(array('class'=>'display rptTable', 'style'=>'width:100%;')), array('class'=>"ui-widget ui-widget-content ui-corner-all hhk-tdbox", 'id'=>'hhk-reportWrapper')), array('autocomplete'=>'off'));
    }
    ...
    public function getReportScriptConfig(): array {
        $uS = Session::getInstance();
        return array_merge($this->filter->getTimePeriodScriptConfig(), [
            'reportName' => $this->inputSetReportName,
            'reportClass' => (new \ReflectionClass($this))->getShortName(),
            'defaultFields' => $this->getDefaultFields(),
            'rendered' => $this->rendered,
            'columnDefs' => $this->colSelector->getColumnDefs(),
            'dateTimeColumnDefs' => $this->colSelector->getDateTimeColumnDefs(),
            'dayColumnDefs' => $this->colSelector->getDayColumnDefs(),
            'defaultSortCol' => $this->defaultSortCol,
            'reportTitle' => $this->reportTitle,
            'reportTitleDecoded' => html_entity_decode($this->reportTitle),
            'username' => $uS->username,
            'dateTimeFormat' => Labels::getString("momentFormats", 'dateTime', 'MMM D, YYYY h:mm a'),
        ]);
    }
...
';
    ...
    public function generateEmailDialog(){
        ...
        return HTMLContainer::generateMarkup("div", $emTbl->generateMarkup(), array("class"=>"emRptDialog", "style"=>"display:none;"));
    }
