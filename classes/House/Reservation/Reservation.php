...
where rg.idReservation =" . $r['idReservation']);
    ...
    public function createStatusChooser(Reservation_1 $resv, array $resvStatuses, array $payTypes, $labels, $showPayWith, $moaBalance = 0) {
        ...
        $tbl2->addBodyTr(
                ($showPayWith ? HTMLTable::makeTd(HTMLSelector::generateMarkup(HTMLSelector::doOptionsMkup(Common::removeOptionGroups($payTypes), $resv->getExpectedPayType()), ['name'=>'selPayType'])) : '')
