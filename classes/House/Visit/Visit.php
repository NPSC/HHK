...
class Visit {
    ...
    /**
     * Summary of replaceStays
     * @param \PDO $dbh
     * @param mixed $oldStayStatus
     * @param mixed $newSpanStatus
     * @param mixed $uname
     * @param mixed $stayOnLeave
     * @throws \HHK\Exception\RuntimeException
     * @return void
    ...
    /**
     * Summary of addStay
     * @param \HHK\Tables\Visit\StaysRS $oldStay
     * @param mixed $stayOnLeave
     * @param mixed $spanStDate
     * @throws \HHK\Exception\RuntimeException
     * @return void
     */
