    ...
    function __construct($page_Type = WebPageCode::Page, $addCSP = TRUE) {
        ...
        */
        ...
        if ($addCSP) {
            ...
            header("Content-Security-Policy: default-src $cspURL https://online.instamed.com https://pay.instamed.com data:; script-src $cspURL 'unsafe-inline' https://online.instamed.com; style-src $cspURL https://online.instamed.com 'unsafe-inline';"); // FF 23+ Chrome 25+ Safari 7+ Opera 19+
