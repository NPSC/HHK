...
class Fin_ApplicationRS extends AbstractTableRS {
    ...
    public DB_Field $idFin_application;   // int(11) NOT NULL AUTO_INCREMENT,
    ...
    public DB_Field $Monthly_Income;  // int(11) NOT NULL DEFAULT '0',
    public DB_Field $HH_Size;  // int(11) NOT NULL DEFAULT '0',
    public DB_Field $FA_Category;  // varchar(5) NOT NULL DEFAULT '',
    public DB_Field $Est_Amount;  // int(11) NOT NULL DEFAULT '0',
    public DB_Field $Estimated_Arrival;  // datetime DEFAULT NULL,
    public DB_Field $Estimated_Departure;  // datetime DEFAULT NULL,
    public DB_Field $Approved_Id;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $FA_Applied;   // varchar(2) NOT NULL DEFAULT '',
    public DB_Field $FA_Applied_Date;   // datetime DEFAULT NULL,
    public DB_Field $FA_Status;   // varchar(5) NOT NULL DEFAULT '',
    public DB_Field $FA_Status_Date;   // datetime DEFAULT NULL,
    public DB_Field $FA_Reason;   // varchar(445) NOT NULL DEFAULT '',
