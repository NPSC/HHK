...
class VisitRS extends AbstractTableRS {
    ...
    public DB_Field $idVisit;   // int(11) NOT NULL AUTO_INCREMENT,
    public DB_Field $Span;   // INT NOT NULL ,
    public DB_Field $idRegistration;   // INT NOT NULL ,
    public DB_Field $idReservation;   // INT NOT NULL ,
    public DB_Field $idResource;   // INT NOT NULL ,
    public DB_Field $idPrimaryGuest;  // int(11) NOT NULL DEFAULT '0',
    public DB_Field $idHospital_stay;  // int(11) NOT NULL DEFAULT '0',
    public DB_Field $Arrival_Date;   // DATETIME NULL DEFAULT NULL ,
    public DB_Field $Title;
    public DB_Field $Key_Deposit;   // DECIMAL(10,2) NOT NULL DEFAULT '0.00' ,
    public DB_Field $Expected_Departure;   // DATETIME NULL DEFAULT NULL ,
    public DB_Field $Actual_Departure;   // DATETIME NULL DEFAULT NULL ,
    public DB_Field $Return_Date;   // DATETIME NULL DEFAULT NULL ,
    public DB_Field $Key_Dep_Disposition;   // VARCHAR(4) NOT NULL DEFAULT '' ,
    public DB_Field $DepositPayType;  // VARCHAR(5) NOT NULL DEFAULT ''
    public DB_Field $Ext_Phone_Installed;   // INT(1) NOT NULL DEFAULT 0 ,
    public DB_Field $Medical_Cooler;   // INT(1) NOT NULL DEFAULT '',
    public DB_Field $Wheel_Chair;   // INT(1) NOT NULL DEFAULT '',
    public DB_Field $Recorded;   // INT(1) NOT NULL DEFAULT '',
    public DB_Field $OverRideMaxOcc;  // int(1) NOT NULL DEFAULT '0',
    public DB_Field $Span_Start;  // datetime DEFAULT NULL,
    public DB_Field $Span_End;  // datetime DEFAULT NULL,
    public DB_Field $Notice_to_Checkout; //datetime DEFAULT NULL,
    public DB_Field $Expected_Rate;   // decimal(10,2) NOT NULL DEFAULT '0.00',
    public DB_Field $Pledged_Rate;   // decimal(10,2) NOT NULL DEFAULT '0.00',
    public DB_Field $Amount_Per_Guest;  // decimal(10,2) NOT NULL DEFAULT '0.00',
    ...
    public DB_Field $Checked_In_By; // VARCHAR(45) NOT NULL DEFAULT '' ,
