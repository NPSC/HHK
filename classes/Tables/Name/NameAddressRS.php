...
class NameAddressRS extends AbstractTableRS {
    ...
    public DB_Field $idName_Address;  // int(11) NOT NULL AUTO_INCREMENT,
    public DB_Field $idName;  // int(11) NOT NULL,
    public DB_Field $Purpose;  // varchar(25) NOT NULL DEFAULT '',
    public DB_Field $Address_1;  // varchar(200) NOT NULL DEFAULT '',
    public DB_Field $Address_2;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $City;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $State_Province;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Postal_Code;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Country;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Country_Code;  // varchar(10) NOT NULL DEFAULT '',
    public DB_Field $County;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Meters_From_House; //int(11) NULL,
    public DB_Field $DistCalcType; //VARCHAR(10) NULL DEFAULT NULL,
    public DB_Field $Set_Incomplete;  // bit(1) NOT NULL DEFAULT b'0',
    public DB_Field $Mail_Code;  // varchar(5) NOT NULL DEFAULT '',
    public DB_Field $Last_Verified;  // datetime DEFAULT NULL,
    public DB_Field $Bad_Address;  // varchar(15) NOT NULL DEFAULT '',
