...
class NameRS extends AbstractTableRS {
    ...
    public DB_Field $idName;  // int(11) NOT NULL AUTO_INCREMENT,
    public DB_Field $Name_First;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Name_Last;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Name_Middle;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Name_Nickname;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Name_Full;  // varchar(170) NOT NULL DEFAULT '',
    public DB_Field $Name_Previous;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Web_Site;  // varchar(145) NOT NULL DEFAULT '',
    public DB_Field $Member_Since;  // datetime DEFAULT NULL,
    public DB_Field $Prev_MT_Change_Date;  // datetime DEFAULT NULL,
    public DB_Field $Date_Added;  // datetime DEFAULT NULL,
    public DB_Field $BirthDate;  // datetime DEFAULT NULL,
    public DB_Field $Member_Status_Date;  // datetime DEFAULT NULL,
    public DB_Field $Date_Deceased;  // DATETIME NULL DEFAULT NULL
    public DB_Field $Member_Type;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Member_Status;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Previous_Member_Type;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Member_Category;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Preferred_Mail_Address;  // varchar(5) NOT NULL DEFAULT '',
    public DB_Field $Preferred_Email;  // varchar(5) NOT NULL DEFAULT '',
    public DB_Field $Preferred_Phone;  // varchar(5) NOT NULL DEFAULT '',
    public DB_Field $Organization_Code;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $External_Id;  // VARCHAR(25) NOT NULL DEFAULT '',
    public DB_Field $Company_Id;  // int(11) NOT NULL DEFAULT '0',
    public DB_Field $Title;  // varchar(75) NOT NULL DEFAULT '',
    public DB_Field $Company;  // varchar(80) NOT NULL DEFAULT '',
    public DB_Field $Company_CareOf;  // varchar(4) NOT NULL DEFAULT '',
    public DB_Field $Record_Member;  // bit(1) NOT NULL DEFAULT b'0',
    public DB_Field $Record_Company;  // bit(1) NOT NULL DEFAULT b'0',
    public DB_Field $Exclude_Directory;  // bit(1) NOT NULL DEFAULT b'0',
    public DB_Field $Exclude_Mail;  // bit(1) NOT NULL DEFAULT b'0',
    public DB_Field $Exclude_Email;  // bit(1) NOT NULL DEFAULT b'0',
    public DB_Field $Exclude_Phone;  // bit(1) NOT NULL DEFAULT b'0',
    public DB_Field $Gender;  // varchar(2) NOT NULL DEFAULT '',
    public DB_Field $Name_Suffix;  // varchar(10) NOT NULL DEFAULT '',
    public DB_Field $Name_Prefix;  // varchar(25) NOT NULL DEFAULT '',
    public DB_Field $Name_Last_First;  // varchar(90) NOT NULL DEFAULT '',
    public DB_Field $Birth_Month;  // int(11) NOT NULL DEFAULT '0',
