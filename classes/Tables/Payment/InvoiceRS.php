...
class InvoiceRS extends AbstractTableRS {
    ...
    public DB_Field $idInvoice;  // int(11) NOT NULL AUTO_INCREMENT,
    public DB_Field $Delegated_Invoice_Id;  // int(11) NOT NULL DEFAULT '0',
    public DB_Field $Invoice_Number;  // varchar(45) DEFAULT NULL,
    public DB_Field $Deleted;  // SMALLINT default 0 NOT NULL,
    public DB_Field $Amount;  // decimal(10,2) NOT NULL DEFAULT '0.00',
    public DB_Field $Sold_To_Id;  //;  // int(11) DEFAULT NULL,
    public DB_Field $idGroup;  // int(11) DEFAULT NULL,
    public DB_Field $Invoice_Date;  // datetime DEFAULT NULL,
    public DB_Field $Payment_Attempts;  // int(11) NOT NULL DEFAULT '0',
    public DB_Field $Status;  // varchar(5) NOT NULL DEFAULT '',
    public DB_Field $Carried_Amount;  // decimal(10,2) NOT NULL DEFAULT '0.00',
    public DB_Field $Balance;  // decimal(10,2) NOT NULL DEFAULT '0.00',
    public DB_Field $Order_Number;  // varchar(45) DEFAULT NULL,
    public DB_Field $Suborder_Number; //   `Suborder_Number` smallint(6) NOT NULL DEFAULT '0',
    public DB_Field $Billing_Process_Id;
    public DB_Field $BillStatus;  // VARCHAR(5) NOT NULL DEFAULT '',
    public DB_Field $BillDate;  // DATE NULL,
    public DB_Field $EmailDate; //DATETIME NULL,
    public DB_Field $Description;  // varchar(45) DEFAULT NULL,
    public DB_Field $Notes;  // varchar(450) DEFAULT NULL,
    public DB_Field $tax_exempt; // tinyint default 0,
