...
class TransRS extends AbstractTableRS {
    ...
    public DB_Field $idTrans;  // int(11) NOT NULL AUTO_INCREMENT,
    public DB_Field $Trans_Type;  // varchar(5) NOT NULL DEFAULT '' COMMENT '	',
    public DB_Field $Trans_Method;  // varchar(5) NOT NULL DEFAULT '',
    public DB_Field $Trans_Date;  // datetime DEFAULT NULL,
    public DB_Field $idName;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Order_Number;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Invoice_Number;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Payment_Type;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Check_Number;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Check_Bank;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Card_Number;  // varchar(4) NOT NULL DEFAULT '',
    public DB_Field $Card_Expire;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Card_Authorize;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Card_Name;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Auth_Code;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $RefNo;  // varchar(25) NOT NULL DEFAULT '',
    public DB_Field $Process_Code;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Gateway_Ref;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Payment_Status;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Amount;  // decimal(10,2) NOT NULL DEFAULT '0.00',
    public DB_Field $Amount_Tendered;  // decimal(10,2) NOT NULL DEFAULT '0.00',
    public DB_Field $Date_Entered;  // datetime DEFAULT NULL,
    public DB_Field $Entered_By;  // varchar(45) NOT NULL DEFAULT '',
