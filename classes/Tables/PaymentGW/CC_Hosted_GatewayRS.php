...
class CC_Hosted_GatewayRS extends AbstractTableRS {
    ...
    public DB_Field $Merchant_Id;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Password;  // varchar(245) NOT NULL DEFAULT '',
    public DB_Field $Credit_Url;  // varchar(145) NOT NULL DEFAULT '',
    public DB_Field $Trans_Url;  // varchar(145) NOT NULL DEFAULT '',
    public DB_Field $Page_Header_URL;  // varchar(145) NOT NULL DEFAULT '',
    public DB_Field $Checkout_Url;  // varchar(145) NOT NULL DEFAULT '',
    public DB_Field $Manual_MerchantId;  // varchar(145) NOT NULL DEFAULT '',
    public DB_Field $Manual_Password;  // varchar(145) NOT NULL DEFAULT '',
    public DB_Field $CheckoutPOS_Url;  // varchar(145) NOT NULL DEFAULT '',
    public DB_Field $CheckoutPOSiFrame_Url;  // varchar(145) NOT NULL DEFAULT '',
