...
class DonationsRS extends AbstractTableRS {
    ...
    public DB_Field $iddonations;  // int(11) NOT NULL AUTO_INCREMENT,
    public DB_Field $Donor_Id;  // int(11) NOT NULL,
    public DB_Field $Care_Of_Id;  // int(11) NOT NULL DEFAULT '0',
    public DB_Field $Assoc_Id;  // int(11) NOT NULL DEFAULT '0',
    public DB_Field $Type;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Date_Entered;  // datetime DEFAULT NULL,
    public DB_Field $Trans_Date;  // datetime DEFAULT NULL,
    public DB_Field $Pay_Type;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Member_type;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Donation_Type;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Amount;  // decimal(15,2) NOT NULL DEFAULT '0.00',
    public DB_Field $Matching_Amount;  // decimal(15,2) NOT NULL DEFAULT '0.00',
    public DB_Field $Note;  // varchar(255) NOT NULL DEFAULT '',
    public DB_Field $Salutation_Code;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Envelope_Code;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Address_1;  // varchar(145) NOT NULL DEFAULT '',
    public DB_Field $Address_2;  // varchar(145) NOT NULL DEFAULT '',
    public DB_Field $City;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $State;  // varchar(5) NOT NULL DEFAULT '',
    public DB_Field $Postal_Code;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Country;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Address_Purpose;  // varchar(5) NOT NULL DEFAULT '',
    public DB_Field $Phone;  // varchar(25) NOT NULL DEFAULT '',
    public DB_Field $Email;  // varchar(145) NOT NULL DEFAULT '',
    public DB_Field $Fund_Code;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Org_Code;  // varchar(15) NOT NULL DEFAULT '',
    public DB_Field $Campaign_Code;  // varchar(45) NOT NULL DEFAULT '',
    public DB_Field $Activity_Id;  // int(11) NOT NULL DEFAULT '0',
    public DB_Field $Date_Acknowledged;  // datetime DEFAULT NULL,
