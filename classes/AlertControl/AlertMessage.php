 ...
 class AlertMessage {
    ...
    public function createMarkup($message = "", $maxWidth = '450px') {
        ...
        if ($this->get_Text() != "") {
            ...
            <div ".$this->get_styleId()." class='" . $this->mState[$this->mContext] . " ui-corner-all p-2' style='padding: .2em .7em;'>
                    <p ><span ".$this->get_iconId()." class='ui-icon ".$this->imageIcons[$this->mContext]." mr-2' style='margin-right: .3em;'></span>".
