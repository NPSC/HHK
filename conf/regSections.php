...
$guestRegSection = '<div><span style="font-style: italic;">In order to ensure the well-being of all residents and guests we ask that <span style="text-decoration: underline;">all guests register with the Front Desk</span>.</div>';
