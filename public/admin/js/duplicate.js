document.addEventListener("DOMContentLoaded", () => {
  $("#searchSel").submit(function (e) {
    ...
    $.post("Duplicates.php", formdata, function (data) {
      "use strict";
      if (!data) {
        ...
        $.post(
          ...
          function (data) {
            ...
            $("#btnCombine").click(function () {
              ...
              $.post(
                "Duplicates.php",
                { cmd: "pik", id: id, mType: $(this).data("type") },
                function (data) {
                  "use strict";
                  if (!data) {
                    alert("Bad Reply from Server");
            ...
            $("#btnCombPSG").click(function () {
              ...
              $.post("Duplicates.php", { cmd: "cpsg", idg: idGood, idb: idBad }, function (data) {
                "use strict";
                if (!data) {
                  alert("Bad Reply from Server");
                  return;
            ...
            $("#btnCombId").click(function () {
              ...
              if (
                confirm(
                  "Are you sure you want to save ID " +
                    idGood +
                    " and remove ID " +
                    idBad +
                ...
                $.post("Duplicates.php", { cmd: "cids", idg: idGood, idb: idBad }, function (data) {
                  "use strict";
                  if (!data) {
                    alert("Bad Reply from Server");
                    return;
