(function ($) {
  ...
  function createActions(jobId, row) {
    ...
    // Edit icon
    $li = $(
      '<li title="Edit Job" data-jobid="' + jobId + '" data-title="' + row.Title + '" />',
    ).addClass("hhk-job-button job-edit ui-corner-all ui-state-default");
    $li.append($('<span class="ui-icon ui-icon-pencil" />'));

    $ul.append($li);

    // Save(Done) Edit Icon
    $li = $('<li title="Save Job" />')
      .addClass("hhk-job-button job-done job-action ui-corner-all ui-state-default")
      .hide();
    ...
    $li = $('<li title="Cancel" data-titletext="' + row.Title + '" />')
      .addClass("hhk-job-button job-cancel job-action ui-corner-all ui-state-default")
      .hide();
    ...
    // Dry Run button
    $li = $('<li title="Dry Run" data-jobid="' + jobId + '" />').addClass(
      "hhk-job-button job-dry-run ui-corner-all ui-state-default",
    );
    $li.append($("Dry Run"));
    ...
    // Force Run button
    $li = $('<li title="Run Now" data-jobid="' + jobId + '" />').addClass(
      "hhk-job-button job-force-run ui-corner-all ui-state-default",
    );
    $li.append($("Run Now"));
