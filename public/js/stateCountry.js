...
var BFHStatesList = {
  ...
  AD: {
    ...
    7: { code: "SJL", name: "Sant Juli�  de Lòria" },
  },
  AO: {
  ...
  PR: {
    ...
    64: { code: "SAN", name: "San Germ� n" },
    65: { code: "SAN", name: "San Juan" },
    66: { code: "SAN", name: "San Lorenzo" },
    67: { code: "SAN", name: "San Sebasti� n" },
...
!(function (e) {
  "use strict";
  var t = function (t, n) {
    this.options = e.extend({}, e.fn.bfhcountries.defaults, n);
    this.$element = e(t);
    if (this.options.countrylist) {
      this.countryList = [];
      this.options.countrylist = this.options.countrylist.split(",");
      for (var r in BFHCountriesList) {
        if (e.inArray(r, this.options.countrylist) >= 0) {
          this.countryList[r] = BFHCountriesList[r];
        }
      }
    } else {
  ...
  t.prototype = {
    ...
    addCountries: function () {
      var e = this.options.country;
      this.$element.html("");
      this.$element.append('<option value=""></option>');
      for (var t in this.countryList) {
        this.$element.append('<option value="' + t + '">' + this.countryList[t] + "</option>");
      }
      this.$element.val(e);
    },
    displayCountry: function () {
      ...
      if (this.options.flags == true) {
        this.$element.html('<i class="icon-flag-' + e + '"></i> ' + this.countryList[e]);
      } else {
        this.$element.html(this.countryList[e]);
      }
    },
  };
  e.fn.bfhcountries = function (n) {
    return this.each(function () {
      var r = e(this),
        i = r.data("bfhcountries"),
        s = typeof n === "object" && n;
      if (!i) r.data("bfhcountries", (i = new t(this, s)));
      if (typeof n === "string") i[n]();
    });
  };
  e.fn.bfhcountries.Constructor = t;
  e.fn.bfhcountries.defaults = { country: "", countryList: "", flags: false };
  e(window).on("load", function () {
    e("select.bfh-countries").each(function () {
      var t = e(this);
...
!(function (e) {
  "use strict";
  var t = function (t, n) {
    this.options = e.extend({}, e.fn.bfhstates.defaults, n);
    this.$element = e(t);
    if (this.$element.is("select")) {
      this.addStates();
    }
  ...
  t.prototype = {
    ...
    addStates: function () {
      var e = this.options.country;
      if (e != "") {
        var t = this.$element.closest("table");
        var n = t.find("#" + e);
        if (n.length != 0) {
          e = n.val();
          n.on("change.bfhcountries.data-api", { stateObject: this }, this.changeCountry);
        }
      }
      this.loadStates(e);
    },
    loadStates: function (e) {
      ...
      this.$element.html("");
      this.$element.append('<option value=""></option>');
      for (var n in BFHStatesList[e]) {
        this.$element.append(
          '<option value="' +
            BFHStatesList[e][n]["code"] +
            '">' +
            BFHStatesList[e][n]["name"] +
            "</option>",
        );
      }
      this.$element.val(t);
    ...
    displayState: function () {
      var e = this.options.country;
      var t = this.options.state;
      this.$element.html(BFHStatesList[e][t]);
    },
  };
  e.fn.bfhstates = function (n) {
    return this.each(function () {
      var r = e(this),
        i = r.data("bfhstates"),
        s = typeof n === "object" && n;
      if (!i) r.data("bfhstates", (i = new t(this, s)));
      if (typeof n === "string") i[n]();
    });
  };
  e.fn.bfhstates.Constructor = t;
  e.fn.bfhstates.defaults = { country: "US", state: "" };
  e(window).on("load", function () {
    e("select.bfh-states").each(function () {
      var t = e(this);
      t.bfhstates(t.data());
    });
  });
          ...
          if (data.success) {
            $.each(data.success, function (i, countyAr) {
              if (county == countyAr.County) {
                ...
                $("#adrcounty").append(
                  "<option value='" + countyAr.County + "'>" + countyAr.County + "</option>",
                );
              }
            });
          } else if (data.error && data.gotopage) {
            flagAlertMessage(
              data.error + ' - <a href="' + data.gotopage + '">Login again</a>',
              true,
            );
          }
        },
