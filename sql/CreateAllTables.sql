...
CREATE TABLE if not exists `payment_auth` (
  ...
  `Status_Code` varchar(5) NOT NULL DEFAULT '',
  `EMVCardEntryMode` VARCHAR(45) NULL ,
  `EMVAuthorizationMode` VARCHAR(45) NULL ,
  `EMVApplicationIdentifier` VARCHAR(45) NULL ,
  `EMVTerminalVerificationResults` VARCHAR(45) NULL ,
  `EMVIssuerApplicationData` VARCHAR(45) NULL AFTER ,
  `EMVTransactionStatusInformation` VARCHAR(45) NULL ,
  `EMVApplicationResponseCode` VARCHAR(45) NULL ,
  `Updated_By` varchar(45) NOT NULL DEFAULT '',
  `Last_Updated` datetime DEFAULT NULL,
  `Timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
