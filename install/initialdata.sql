...
('Auto_Email_Address','','ea','ha','','Notified for each batch of automatic survey emails',''),
...
('CalDateIncrement','1','s','c','','Number of weeks to increment Calendar view, auto = calViewWeeks',''),
...
('ConcatVisitNotes','true','b','h','','Show combined notes from all previous visits when true',''),
('CoTod','false','b','h','','Enable editing the time of day of a checkout',''),
('county','true','b','h','','Include the County in mail addresses',''),
('DefaultDays','21','i','h','','The Default number of following days for date range control',''),
('DefaultPayType','ca','s','f','','Use the Resource Builder',''),
...
('EmailType','','lu','es','','Protocol Type','Email_Server'),
('EmergContactFill','true','b','h','','Insist on Filling in the emergency contact',''),
('EmptyExtendLimit','0','i','h','','Extend visit (go on leave) limit number of days',''),
...
('Guest_Register_Email','','ea','ha','','If present, a guest register is sent here once a day (also must create a cron job)',''),
('Guest_Track_Address','','ea','ha','','If present, these addresess receive all notices of check-in, out, room change, etc.',''),
('GuestAddr','true','b','g','','False = do not collect guest address',''),
('GuestNameColor','hospital','s','h','','Enable Guest demographic to drive guest name background color',''),
...
('HouseKeepingEmail','','ea','ha','','This address received all room turn-over notices',''),
('HouseKeepingSteps','1','lu','h','','Number of steps to cleaning/preparing rooms for new guests','HouseKpgSteps'),
('IncludeLastDay','false','b','h','','Include the departure day in room searches',''),
('IncomeRated','true','b','h','','Enable Income chooser rate assistance',''),
...
('InsistPatBD','false','b','p','','Insist on user filling in the patients birthdate',''),
('InsuranceChooser','false','b','h','','Enable health insurance chooser',''),
('InvoiceTerm','30','i','f','','Invoice payment terms in days',''),
('KeyDeposit','false','b','h','','Enable Room or Key deposit',''),
('LangChooser','false','b','h','','Enable member language chooser',''),
...
('MaxDonate','100000','i','d','','Maximum amount for a single donation',''),
('MaxExpected','120','i','h','','Maximum Expected days out for a visit',''),
...
('NotificationAddress','','ea','f','','Gets financial email notifications', ''),
...
('PatientAsGuest','true','b','p','','Enable patients to stay as guests',''),
('PayAtCkin','true','b','h','','Enable payments at check-in time',''),
...
('PaymentGateway','','lu','fg','','Credit Card Payment Gateway','Pay_Gateway_Name'),
('PayVFeeFirst','false','b','h','','Default check the visit-fees payment checkbox',''),
('PreviousNights','0','i','c','','Previous nights to add to nights counter',''),
...
('RateGlideExtend','0','i','h','','Number of days for the Room Rate Glide to time out after visit check-out',''),
...
('RegColors','','lu','c','','Calendar page ribbon colors based on hospital or room','Reg_Colors'),
('RegForm','1','i','h','','Registration form style',''),
...
('ResvEarlyArrDays','2','i','h','','Number of days before reservations show the check-in button on reservation chooser',''),
...
('SessionTimeout','30','i','a','','Number of minutes until an idle session gets automatically logged out, 0 = never log out',''),
...
('ShowGuestPhoto','false','b','h','','Enable guest photos',''),
...
('UseIncidentReports', 'false', 'b', 'h', '', 'Enable the Incident Reports feature', ''),
('userInactiveDays','','lu','pr','','Number of days of inactivity before user web access becomes disabled','dayIncrements'),
('UseWLnotes','false','b','h','','Enable wait list notes feature on reservations',''),
('VerifyHospDate','false','b','h','','Insist on hospital treatment-date entry',''),
('VisitExcessPaid','d','lu','h','','Default setting for excess visit payments','ExcessPays'),
('VisitFee','false','b','h','','Enable the visit fee (cleaning fee) feature',''),
('VisitFeeDelayDays','0','i','h','','Number of days before cleaning fee is charged',''),
('Volunteers','false','b','a','','Enable HHK Volunteer Manager',''),
('Zip_Code','60115','s','h','','Organization zip code','');
-- ;
