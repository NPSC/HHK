...
('Error_Report_Email', 'support@nonprofitsoftwarecorp.org', 's', 'a', '', 'Email for reporting server errors', ''),
...
('HUF_URL', 'https://forum.hospitalityhousekeeper.net/', 's', 'a', '', 'HHK Users Form', ''),
...
('Run_As_Test', 'false', 'b', 'a', '', 'Run As Test flag', ''),
...
('Site_Maintenance', 'false', 'b', 'a', '', 'Flag to temporarily deny access to the site', ''),
...
('Training_URL', 'https://hospitalityhousekeeper.net/training/', 's', 'a', '', 'HHK Training site URL', ''),
...
--
INSERT INTO `document` (`idDocument`,`Title`,`Name`,`Category`,`Type`,`Mime_Type`,`Folder`,`Language`,`Abstract`,`Doc`,`userData`,`Style`,`Status`,`Last_Updated`,`Created_By`,`Updated_By`) VALUES
