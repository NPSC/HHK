...
('CalResourceGroupBy','Category','s','h','','Calendar resource grouping parameter',''),
('CalViewWeeks','3','i','h','','Number of weeks showing in the calendar view',''),
('CardSwipe','false','b','f','','Use POS terminal',''),
('ccgw','test','s','f','','Credit Card Gateway state:  \'test\' or \'production\'',''),
...
('CoTod','true','b','h','','Edit the time of day of a checkout.',''),
...
('DefaultPayType','cc','s','f','','Default payment type for paying today UI',''),
('DefaultRegisterTab','0','i','h','','Default active tab on register page, 0 = calendar, 1 = current Guests',''),
('DefaultVisitFee','106','s','h','','Default Visit Fee selected on new check-in and reservation pages.',''),
('Disclaimer','Welcome! Please remember that unauthorized use of the data made available to you as a House volunteer, including collecting user names and/or email addresses of other users for the purpose of sending unsolicited email or othe','s','v','','Volunteer Site Disclaimer',''),
('Doctor','true','b','h','','Track doctors',''),
('EmailBlockSize','200','i','r','','Number of email addresses per block.',''),
('EmailType','mail','s','r','','\"mail\" or \"SMTP\"',''),
('EmergContactFill','false','b','h','','Insist on Filling in the emergency contact (or check the \"skip\")',''),
...
('fy_diff_Months','3','i','f','','Fiscal year difference months (12 - fiscal year start month)',''),
...
('HHK_Secret_Key','T3VqSDRZc3FrNlRHMDkxQXBMNzg4THRCTm4vOXlUOGkyeG9ZbHpWT2Y0K0F5elQvZDYyUXFTNWFTRWZyL2pQUg==','ob','v','','Recapcha Secret Key (obfruscated)',''),
...
('PaymentDisclaimer','DISCLAIMER:  The amount of your donation that is deductible for Federal tax purposes is limited to the excess of the amount of your donation over the value of the goods and services provided to you by (House Name).','s','f','','Shows on receipts and statements.',''),
('PaymentGateway','instamed','s','f','','Payment Gateway, either vantiv, instamed or nothing.',''),
('PayVFeeFirst','true','b','h','','Default check the visit fees payment checkbox',''),
('PmtPageLogoUrl','conf/hostpaylogo.jpg','url','f','','',''),
...
('ShowGuestPhoto','true','b','h','','Use guest photos.',''),
...
('sId','11','i','r','','House member Id',''),
('siteName','Hospitality HouseKeeper','s','r','','House or organization  name',''),
('SMTP_Auth_Required','true','b','r','','SMTP Authorization required.',''),
('SMTP_Debug','0','i','r','','0 = off; 1; 2; 3;  4 = low level',''),
('SMTP_Host','','s','r','','SMTP Host',''),
('SMTP_Password','','ob','r','','SMTP user password (Obfuscated)',''),
('SMTP_Port','587','i','r','','',''),
('SMTP_Secure','tls','s','r','','SMTP Security, normally tls',''),
('SMTP_Username','','s','r','','',''),
('SolicitBuffer','9','i','r','','Timeout in days after visit checkout before solicit report will show new guests',''),
...
('tz','America/Chicago','s','r','','America/New_York, America/Chicago, America/Denver, or America/Los_Angeles',''),
...
('VisitFee','true','b','h','','Use the visit fee (cleaning fee) feature',''),
('VisitFeeDelayDays','0','i','h','','Number of days before cleaning fee is charged',''),
('Volunteers','false','b','r','','Use HHK Volunteer Manager',''),
...
-- ('adminEmailAddr', '', 's', 'a', 'Houses admin email address.'),
-- ('CalDateIncrement', '1', 's', 'h', 'Number of weeks to increment Calendar view, "auto"=calViewWeeks'),
-- ('CalExpandResources', 'true', 'b', 'h', 'Initially expand room categories on the calendar'),
-- ('CalViewWeeks','3','i','h','Number of weeks showing in the calendar view'),
-- ('CalRescColWidth', '8%', 's', 'h', 'The width of the rooms column on the calendar page as percent of the overall width.'),
