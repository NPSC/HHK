...
(2,'Registration Form','','form','html','','es',NULL,'<p style=\"margin-bottom:10px;\">El (nombre de la casa) es una casa de hospitalidad sanitaria sin fines de lucro. El Guest House es estrictamente un centro de alojamiento para pacientes referidos que reciben atenciÃ³n activa en nuestras instituciones asociadas y sus familiares / amigos.</span></p>\r\n<ul style=\"list-style-type:disc;margin-left: 20px;\">\r\n    <li><span style=\"font-weight: bold;\">Todos los huÃ©spedes deben registrarse en la recepciÃ³n</span></li>\r\n    <li><span style=\"font-weight: bold;\">EstÃ¡ estrictamente prohibido fumar.</span></li>\r\n    <li><span \">El personal debe tener acceso a la sala para realizar tareas de limpieza y mantenimiento regulares. Las habitaciones deben mantenerse ordenadas para garantizar que se limpien adecuadamente.</span></li>\r\n    <li><span style=\"font-weight: bold;\">En caso de emergencia,</span> llamada ###.</li>\r\n    <li><span style=\"font-weight: bold;\">Se prohÃ­ben las mascotas.</span> Si se encuentra una mascota en una habitaciÃ³n de invitados, el personal pedirÃ¡ que se retire y puede pedirle a los huÃ©spedes que abandonen las instalaciones.</li>\r\n    <li>No queme velas, incienso ni ningÃºn otro objeto inflamable en las habitaciones.</li>\r\n    <li><span style=\"font-weight: bold;\">Los alimentos deben almacenarse adecuadamente</span> en contenedores sellados o en el refrigerador. Deseche los alimentos adecuadamente al momento de la salida.</li>\r\n    <li><span style=\"font-weight: bold;\">No quite nada de las habitaciones.</span></li>\r\n    <li><span style=\"font-weight: bold;\">No intente hacer reparaciones usted mismo.</span> ComunÃ­quese con el gerente de la casa o la recepciÃ³n para cualquier problema con electrodomÃ©sticos, enchufes o tuberÃ­as.</li>\r\n    <li>La casa se esfuerza por proporcionar una comunidad de apoyo y bienvenida para sus huÃ©spedes; ayÃºdenos siendo respetuosos con todo el personal, los voluntarios, los demÃ¡s huÃ©spedes y los residentes.</li>\r\n    <li><span style=\"font-weight: bold;\">Hora de salida es las 10 AM.</span> Deje sus llaves en la recepciÃ³n.</li>\r\n</ul>\r\n<p style=\"margin-top:10px;\">El incumplimiento de cualquiera o todas estas polÃ­ticas o el abuso del privilegio de permanecer en la casa de todos modos puede resultar en la pÃ©rdida de la estadÃ­a de la familia. Los huÃ©spedes son responsables de comunicar cualquier problema o problema directamente al (personal).</p>\r\n<p style=\"margin-top:10px;\"><span style=\"font-weight: bold;\">Descargo de responsabilidad:</span>  He ejecutado este lanzamiento voluntariamente y entiendo eso al firmar este lanzamiento. Renuncio a cualquier derecho que pueda tener para demandar o hacer cualquier reclamo o demanda en mi nombre o en nombre de cualquier miembro de la familia por las lesiones sufridas durante el curso de la residencia en la CÃ¡mara. Entiendo y pretendo que este comunicado cubra todas las lesiones, incluso si tales lesiones son el resultado de la negligencia de la (Casa) o de cualquier persona asociada con la Casa. La autorizaciÃ³n y la liberaciÃ³n constituyen el acuerdo completo entre la CÃ¡mara y yo con respecto a los temas tratados en este documento. La casa se reserva el derecho de inspeccionar cualquier habitaciÃ³n en cualquier momento.</p>\r\n<p style=\"font-weight: bold;margin-top:10px; font-style: italic;\">He / hemos leÃ­do, entendido y acepto todas las condiciones de este acuerdo que recibÃ­ / recibimos hoy. Al firmar este formulario de registro de invitado, Acepto / aceptamos cumplir con las reglas y regulaciones de la CÃ¡mara y lo comunicarÃ© a los demÃ¡s miembros de mi grupo.</p>\r\n','a',NULL,'','patch','2019-10-12 20:12:34');
