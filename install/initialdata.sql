...
VALUES
	...
	(
		'Calendar_Status_Colors',
		'copast',
		'Checked in past Expected Departure',
		'',
		'u',
		80
	),
	...
	(
		'cronJobTypes',
		'SendPostCheckoutEmailJob',
		'Send Post Check In/Out Email',
		'',
		'',
		0
	),
	...
	(
		...
		'js/rte-agreement.json',
		'',
		0
	),
	(
		'Editable_Forms',
		'../conf/confirmation.txt',
		'Confirmation Form',
		'js/rte-confirmation.json',
		'',
		0
	),
	(
	...
	(
		'Ethnicity',
		'x',
		'Other race or ethnicity not listed here',
		'',
		'd',
		80
	),
...
VALUES
	...
	(
		'Oauth_Scopes',
		'calendar:read',
		'Read reservations and visit events from the calendar',
		'',
		'',
		0
	),
...
VALUES
	(
		...
		'h',
		'',
		'Accept payments at Reservation Comfirmation',
		'',
		'1'
	),
	(
		...
		'ha',
		'',
		'Notified for each batch of automatic emails',
		'',
		1
	),
	(
		...
		'fg',
		'',
		'Batch settlement time of day for auto-settlements',
		'',
		0
	),
	(
		...
		'g',
		'',
		'Any email addresses listed here (comma delimited) will get a BCC of any receipts mailed to valid guest email accounts.',
		'',
		1
	),
	(
		...
		'c',
		'',
		'Number of weeks to increment Calendar view, auto = calViewWeeks',
		'',
		1
	),
	(
		...
		'c',
		'',
		'Initially expand room categories on the calendar',
		'',
		1
	),
	(
		...
		'c',
		'',
		'The width of the rooms column on the calendar page as percent of the overall width or pixels',
		'',
		1
	),
	(
		...
		'c',
		'',
		'Calendar resource grouping parameter',
		'Room_Group',
		1
	),
	(
		...
		'c',
		'',
		'Number of weeks showing in the calendar view',
		'',
		1
	),
	(
		...
		'h',
		'',
		'CC referral agent on reservation confirmation email',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Normal House Check in time of day in 24-hour format, hh',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Normal House Checkout time of day in 24-hour format, hh',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Show notes combined from all previous visits when true',
		'',
		1
	),
	(
		...
		'hf',
		'',
		'Integrate an External CRM/Fund Raiser App',
		'ExternalCrm',
		1
	),
	(
		...
		'hf',
		'',
		'Edit the time of day of a checkout',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Include the County for addresses',
		'',
		1
	),
	(
		'CssValidationService',
		'https://jigsaw.w3.org/css-validator/validator?output=soap12&text=',
		'url',
		'a',
		'',
	...
	(
		...
		'h',
		'',
		'Show this Demographic category on the Current Guests tab as an icon',
		'Demographics',
		1
	),
	(
		'DefaultCalEventColor',
		'',
		's',
		'c',
		'',
		'Default event ribbon color for the calendar',
		'',
		1
	),
	(
		...
		'h',
		'',
		'The Default number of following days for date range control',
		'',
		1
	),
	(
	...
	(
		...
		'h',
		'',
		'Default active tab on register page',
		'Default_Reg_Tab',
		1
	),
	(
	...
	(
		...
		'c',
		'',
		'Default calendar event ribbon text color',
		'',
		1
	),
	(
	...
	(
		...
		'es',
		'',
		'Domain name of sender (must match FromAddress and NoReplyAddr domains)',
		'',
		1
	),
	(
	...
	(
		...
		'h',
		'',
		'Insist on Filling in the emergency contact',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Collect Emergency Contact on Reservation',
		'',
		1
	),
	(
		...
		'hf',
		'',
		'Extend visit (go on leave) default number of days',
		'',
		1
	),
	(
		'Error_Report_Email',
		'support@nonprofitsoftwarecorp.org',
		's',
		'a',
		'',
		'Email for reporting server errors',
		'',
		0
	),
	(
	...
	(
		...
		'h',
		'',
		'Extend the Check in day by this many hours into tomorrow',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Force  name prefixes to be entered',
		'',
		1
	),
	(
		...
		'g',
		'',
		'House from address for guest emails',
		'',
		1
	),
	(
		...
		'f',
		'',
		'Fiscal year difference months (12 - fiscal year start month)',
		'',
		1
	),
	(
		...
		'ha',
		'',
		'If present, these addresess receive all notices of check-in, out, room change, etc.',
		'',
		1
	),
	(
	...
	(
		...
		'ha',
		'',
		'This address receives all room turn-over notices',
		'',
		1
	),
	(
		...
		'hf',
		'',
		'Number of steps to cleaning/preparing rooms for new guests',
		'HouseKpgSteps',
		1
	),
	(
		...
		'h',
		'',
		'Include the departure day in room searches',
		'',
		1
	),
	(
		...
		'hf',
		'',
		'Enable guest income chooser rate assistance',
		'',
		1
	),
  (
  ...
  (
	...
	(
		...
		'h',
		'',
		'Initial reservation status setting, confirmed or unconfirmed',
		'Init_Reserv_Status',
		1
	),
	(
		...
		'h',
		'',
		'Insist phone for all guests be filled in on check in page',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Insist email for all guests be filled in on check in page',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Insist valid address for all guests be filled in on check in page',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Hide "# days" room fee calculator on Paying Today',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Insist that user fill in the demographics on the check in page',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Insist the user fills in the payment amount on checkin page',
		'',
		1
	),
	(
	...
	(
		...
		'p',
		'',
		'Insist on user filling in the patients birthdate',
		'',
		1
	),
	(
	...
	(
		...
		'a',
		'',
		'Filesystem path to SAML and DKIM keys',
		'',
		0
	),
	(
		...
		'hf',
		'',
		'Enable member language chooser',
		'',
		1
	),
	(
		'loginFeedURL',
		'https://manage.hospitalityhousekeeper.net/tips/current',
		'url',
		'a',
		'',
		'Feed for login pages',
		'',
		'0'
	),
	(
	...
	(
		...
		'h',
		'',
		'Maximum number of automatic email messages to send per batch',
		'',
		1
	),
	(
		...
		'd',
		'',
		'Maximum amount amount for a single donation',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Maximum Expected days out for a visit',
		'',
		1
	),
	(
		...
		"h",
		"",
		"Max number of search results displayed in autocomplete searches",
		"searchResultCount",
		1
	),
	(
	...
	(
		...
		'f',
		'',
		'Print customer and merchant receipt on single page',
		'',
		1
	),
	(
		...
		"h",
		'',
		"Enforce a minimum length for reservations, 0 = no minimum",
		'',
		1
	),
	(
		...
		'a',
		'',
		'Site Operational Mode',
		'Site_Mode',
		0
	),
	(
		'NewsletterURL',
		'https://nonprofitsoftwarecorp.us18.list-manage.com/subscribe?u=473b86d29e0f6f7ba7434f9a2&id=b986c7beaa',
		'url',
		'a',
		'',
		'Newsletter iframe URL',
		'',
		0
	),
	(
		...
		'c',
		'',
		'Count nights by year (calYear) or by grand total',
		'',
		1
	),
	(
	...
	(
		...
		'h',
		'',
		'Show Notice to Checkout date box on visits',
		'',
		1
	),
	(
		...
		'f',
		'',
		'Gets financial data upload notifications',
		'',
		1
	),
	(
	...
	(
		...
		'pr',
		'',
		'Number of days between automatic password resets',
		'dayIncrements',
		1
	),
	(
	...
	(
		...
		'p',
		'',
		'House allows patients to stay as guests',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Allow/Disallow payments at check-in time',
		'',
		1
	),
	(
		'PaymentDisclaimer',
		'The amount of your donation that is deductible for Federal tax purposes is limited to the excess of the amount of your donation over the value of the goods and services provided to you by (House Name).  Because the estimated value of the goods and services provided to you by (House Name) exceeds the value of your donation, no part of your donation is deductible for Federal tax purposes.',
		't',
		'f',
		'',
		'Shows on receipts and statements',
		'',
		1
	),
	(
...
(house name)',
		...
		'f',
		'',
		'Default email body for Invoices',
		'',
		1
	),
	(
...
(house name)',
		...
		'f',
		'',
		'Default email body for Statements',
		'',
		1
	),
	(
...
(house name)',
		...
		'f',
		'',
		'Default email body for Receipts',
		'',
		1
	),
	(
		...
		"f",
		"",
		"Automatically email receipts when taking guest payments",
		"",
		1
	),
	(
		"autoEmail3rdPartyReceipts",
		"false",
		"b",
		"f",
		"",
		"Automatically email receipts when taking 3rd party (billing agent) payments",
		"",
		1
	),
	(
	...
	(
		...
		'h',
		'',
		'Default check the visit fees payment checkbox',
		'',
		1
	),
	(
		...
		'c',
		'',
		'Previous (to HHK) nights to add to nights counter',
		'',
		1
	),
  (
	...
	(
		...
		'pr',
		'',
		'Number of prior passwords user cannot reuse',
		'',
		1
	),
	(
		...
		'h',
		'',
		'True = only authorized users can change the defailt room rate',
		'',
		1
	),
	(
		...
		'hf',
		'',
		'(Deprecated) Number of days for the Room Rate Glide to time out after visit check-out',
		'',
		0
	),
	(
		'receiptLogoFile',
		'../conf/receiptlogo.png',
		'url',
		'f',
		'',
		'Path to the receipt logo file',
		'',
		1
	),
	(
	...
	(
		...
		'hf',
		'',
		'Track referral agents/social workers',
		'',
		1
	),
	(
		...
		'ha',
		'',
		'Notify this address when a new referral form is submitted',
		'',
		'1'
	),
	(
		...
		'h',
		'',
		' Registration form style (1 or 2) Use 3 for signing regforms',
		'',
		0
	),
	(
		...
		'h',
		'',
		'Do not show the room number on the registration form before check-in',
		'',
		0
	),
	(
		...
		'h',
		'',
		'On Registrations, minors will not show up in the signature section',
		'',
		'1'
	),
	(
	...
	(
		...
		'pr',
		'',
		'Number of days users can save a device and skip two factor authentication',
		'dayIncrements',
		1
	),
	(
		...
		'g',
		'',
		'The reply to address for any email sent to guests.',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Number of days before reservation to show check-in button on reservation chooser',
		'',
		1
	),
	(
		...
		'c',
		'',
		'Ribbon bottom-bar color source',
		'RibbonColors',
		'1'
	),
	(
		...
		'c',
		'',
		'Ribbon Background color source',
		'RibbonColors',
		1
	),
	(
		...
		'c',
		'',
		'Type of text shown on the calendar ribbon',
		'RibbonText',
		1
	),
	(
		...
		'c',
		'',
		'Use Room Color or housekeeping status for Rooms column on calendar',
		'RoomColors',
		'1'
	),
	(
		...
		'h',
		'',
		'Room rate price model - Do not change!',
		'Price_Model',
		0
	),
	(
	...
	(
		...
		'h',
		'',
		'Number of simultaneous rooms per patient allowed',
		'',
		1
	),
	(
		...
		'c',
		'',
		'Only include this Room Category in room occupancy percentage on calendar',
		'Room_Category',
		'1'
	),
	(
	...
	(
		...
		'a',
		'',
		'Number of minutes until an idle session get automatically logged out, default 30, max 45',
		'',
		1
	),
	(
		...
		'c',
		'',
		'Show the stays counter on the House Calendar page',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Show primary guest address on receipts',
		'',
		'1'
	),
	(
		...
		'h',
		'',
		'Show birthdate for patients and guests',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Show the Created Date in Register page tabs lists',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Show demographics selectors on Check in and Reservation pages',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Show the patient diagnoses on the statements',
		'',
		'1'
	),
	(
		...
		'h',
		'',
		'Show the diagnosis textbox (in addition to the diagnosis selector)',
		'',
		1
	),
	(
		...
		'hf',
		'',
		'Show Guest Photos on Current Guests tab',
		'',
		'1'
	),
	(
		...
		'h',
		'',
		'Use Autocomplete search in place of Diagnosis drop down',
		'',
		'1'
	),
	(
	...
	(
		...
		'h',
		'',
		'Show dates on lodging invoice lines',
		'',
		1
	),
	(
		...
		'f',
		'',
		'Show Rate detail on statements',
		'',
		1
	),
	(
		'showResvHousekeeping',
		'false',
		'b',
		'h',
		'',
		'Show reservations on Guests Checking Out tab of Housekeeping',
		'',
		1
	),
	(
		...
		'c',
		'',
		'Show current occupancy percentage on calendar',
		'',
		'1'
	),
	(
		...
		'h',
		'',
		'Always Show the Transfer pay type',
		'',
		1
	),
	(
		'ShowUncfrmdStatusTab',
		'false',
		'b',
		'h',
		'',
		'Show the Unconfirmed reservations tab on the House Register page',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Include 0-day stays and visits in Reports and Pages',
		'',
		1
	),
	(
	...
	(
		...
		'h',
		'',
		'Show City and Distance on register tabs',
		'',
		1
	),
	(
		...
		'h',
		'',
		'On Registrations, show empty fields',
		'',
		'1'
	),
	(
		...
		'c',
		'',
		'Indicate holidays on the calendar',
		'',
		'1'
	),
	(
		...
		'c',
		'',
		'Indicate closed days on the calendar',
		'',
		'1'
	),
	(
		...
		'f',
		'',
		"Show the room rate title on Statements",
		'',
		'1'
	),
	(
	...
	(
		...
		'sms',
		'',
		'Account Phone number used as the From address',
		'',
		1
	),
	(
	...
	(
		...
		'a',
		'',
		'Timeout in days after visit checkout before solicit report will show new guests',
		'',
		1
	),
	(
	...
	(
		...
		'g',
		'',
		'For by-guest pricing, anyone younger does not get charged.',
		'',
		1
	),
	(
		...
		'a',
		'',
		'Start year for reports, etc.',
		'',
		1
	),
	(
		'statementLogoFile',
		'../conf/registrationLogo.png',
		'url',
		'f',
		'',
		'',
	...
	(
		...
		'f',
		'',
		'Member Id to use for House Discount payment source',
		'',
		1
	),
	(
	...
	(
		'Training_URL',
		'https://hospitalityhousekeeper.net/training/',
		's',
		'a',
		'',
		'HHK Training site URL',
		'',
		0
	),
	(
		'Tutorial_URL',
		'https://www.youtube.com/channel/UC_Sp1kHz_c0Zet0LrO91SbQ/videos/',
		's',
		'a',
		'',
		'Tutorial YouTube page',
		'',
		0
	),
	(
	...
	(
		...
		'hf',
		'',
		'Show the house waive checkbox on checkout',
		'',
		1
	),
	(
		...
		'hf',
		'',
		'Enable the Incident Reports feature',
		'',
		1
	),
	(
		...
		'hf',
		'',
		'Automatically rebook cancelled reservation',
		'',
		1
	),
	(
		...
		'pr',
		'',
		'Number of days of inactivity before user becomes disabled',
		'dayIncrements',
		1
	),
	(
	...
	(
		...
		'hf',
		'',
		'Enable public online referrals',
		'',
		1
	),
	(
	...
	(
		...
		'hf',
		'',
		'Enable wait list notes feature on reservations',
		'',
		1
	),
	(
		...
		'hf',
		'',
		'Set holidays as housekeeping black-out days',
		'',
		'1'
	),
	(
		...
		'ha',
		'',
		'Notified of Vehicle Report (configured in Job Scheduler)',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Insist on hospital treatment date entry',
		'',
		1
	),
	(
		...
		'h',
		'',
		'Default place for excess visit payments',
		'ExcessPays',
		1
	),
	(
		...
		'hf',
		'',
		'Enable the visit fee (cleaning fee) feature',
		'',
		1
	),
	(
		...
		'hf',
		'',
		'Number of days before cleaning fee is charged',
		'',
		1
	),
	(
		...
		'a',
		'',
		'Enable the HHK Volunteer Manager site',
		'',
		0
	),
	(
		...
		'a',
		'',
		'Organization zip code, used for distance calculations',
		'',
		1
	),
	(
		'googleProjectID',
		'helical-clock-316420',
		's',
		'ga',
		'',
	...
	(
		'recaptchaApiKey',
		'bTVWSFUyRXBQU3RHRTlCV0M4WkhGcnh6RC9tbTk5eXp1c3B1NU9JYm1zMVRTcytsemRJSjhtS2w5dnNkZWZKVw==',
		's',
		'ga',
		'',
		'Google API Key for Recaptcha',
		'',
		0
	),
	(
		'recaptchaSiteKey',
		'6LemLyQbAAAAAKKaz91-FZCSI8cRs-l9DCYmEadO',
		's',
		'ga',
		'',
		'Google API Site Key for Recaptcha',
		'',
		0
	);
...
VALUES
	(
		...
		'rg',
		'',
		'Default: Confirmed Reservations'
	),
	(
		'unconfirmedTab',
		...
		'rg',
		'',
		'Default: UnConfirmed Reservations'
	),
	(
		'waitlistTab',
		'Wait Listed',
	...
	(
		'reservationChooserTitle',
		'Reservation Chooser',
		's',
		'rf',
		'',
		'Default: Reservation Chooser'
	),
	(
		'newButtonLabel',
		'New Reservation',
	...
	(
		...
		'rf',
		'',
		'Default: Checkout Survey'
	),
	(
		'VisitFeeConfirmLabel',
		'Cleaning Fee:',
		's',
		'rf',
		'',
	...
	(
		'specialNoteConfEmail',
		'Special Note',
		's',
		'rf',
		'',
		'Default: Special Note'
	),
	(
		'drivingdistancePrompt',
		'Distance',
		's',
		'rf',
		'',
	...
	(
		'guestInstructions',
		'Type in the guest name to check in.',
		's',
		'ck',
		'',
		''
	...
	(
		'paymentTotalLabel',
		'Payment Total (Thank You!)',
		's',
		's',
		'',
		'Default: Payment Total (Thank You!)'
	),
	(
		'noPaymentsRecordedLabel',
		'No Payments Recorded',
		's',
		's',
		'',
		'Default: No Payments Recorded'
	),
	(
		'zeroBalanceLabel',
		'Current Balance',
	...
	(
		...
		's',
		'',
		'Default: Current Balance Due'
	),
	(
		'guestCreditLabel',
		'Current Guest Credit',
		's',
		's',
		'',
		'Default: Current Guest Credit'
	),
	(
		'psgLabel',
		'Patient Support Group',
...
-- ;
REPLACE INTO `operating_schedules` (
	`idDay`,
	`Day`,
	`Start_Date`,
	`Open_At`,
...
-- ;
replace into `item` (`idItem`, `Description`)
values
	(1, 'Lodging'),
	(2, 'Cleaning Fee'),
	(3, 'Deposit'),
...
-- ;
REPLACE INTO `item_type_map` (`Item_Id`, `Type_Id`)
values
	(1, 4),
	(2, 1),
	(3, 3),
...
-- ;
REPLACE INTO `payment_method` (`idPayment_method`, `Method_Name`)
VALUES
	('1', 'Cash'),
	('2', 'Charge'),
	('3', 'Check'),
...
-- ;
Replace into `location` (`idLocation`, `Status`)
VALUES
	(1, 'a');

-- ;
REPLACE INTO `insurance_type` (
	`idInsurance_type`,
	`Title`,
	`Is_Primary`,
	`List_Order`
...
VALUES
	(
		-1,
		'admin',
		'539e17171312c324d3c23908f85f3149',
		false,
		false,
		'a',
		'',
	...
	(
		10,
		'npscuser',
		'VEFhRldOWVFqVmZ5bjhENVZvd29ldz09',
		false,
		false,
		'a',
		'',
...
VALUES
	...
	(
		'dna',
		'Donors (No Amounts)',
		'View lists of donors but without donation amounts',
		'',
		'',
		'',
		'\0',
	...
	(
		'g',
		'Guest Operations',
		'Guest Operations, basic access to guest tracking site',
		'',
		'',
		'',
		'\0',
	...
	(
		'ga',
		'Guest Admin',
		'Guest Administration level access to guest tracking site',
		'',
		'',
		'',
		'\0',
	...
	(
		'mm',
		'Member Management',
		'Member Management, basic access to admin site.',
		'',
		'',
		'',
		'\0',
...
-- ;
REPLACE INTO `neon_lists` (`Method`, `List_Name`, `List_Item`, `HHK_Lookup`)
VALUES
	(
		'account/listIndividualTypes',
		'individualTypes',
		'individualType',
		'Vol_Type'
	),
	...
	(
		'common/listCreditCardTypes',
		'creditCardTypes',
		'creditCardType',
		'Charge_Cards'
	),
	(
		'account/listRelationTypes',
		'relationTypes',
		'relationType',
		'Patient_Rel_Type'
	);
...
--
REPLACE INTO `counter` (`seqn`, `Table_Name`, `Next`, `Last_Updated`)
VALUES
...
-- ;
REPLACE into `transaction_type` (`idtransaction_type`, `Title`, `Effect`, `Code`)
values
	(1, 'Sale', '', 's'),
	(2, 'Void', '', 'vs'),
	(3, 'Return', '', 'r'),
...
--
REPLACE INTO `street_suffix` (`Common`, `Standard`, `TitleCaps`)
VALUES
	('ALLEE', 'ALY', 'Aly'),
	('ALLEY', 'ALY', 'Aly'),
	('ALLY', 'ALY', 'Aly'),
...
--
REPLACE INTO `secondary_unit_desig` (
	`Common`,
	`Standard`,
	`Range_Required`,
	`TitleCaps`
...
VALUES
	...
	('20', 'slf', 'par', 'slf', 'par'),
	('21', 'sp', 'rltv', 'sp', 'rltv'),
	('22', 'sib', 'rltv', 'sib', 'rltv'),
	('23', 'chd', 'rltv', 'par', 'rltv'),
	('24', 'par', 'rltv', 'chd', 'rltv'),
	('25', 'sp', 'frd', 'sp', 'frd'),
	('26', 'sib', 'frd', 'seb', 'frd'),
	('27', 'chd', 'frd', 'par', 'frd'),
	('28', 'par', 'frd', 'chd', 'frd'),
	('29', 'rltv', 'sp', 'rltv', 'rltv'),
	('30', 'rltv', 'sib', 'rltv', 'rltv'),
	('31', 'rltv', 'chd', 'rltv', 'rltv'),
	('32', 'rltv', 'par', 'rltv', 'rltv'),
	('33', 'frd', 'sp', 'frd', 'frd'),
	('34', 'frd', 'sib', 'frd', 'frd'),
	('35', 'frd', 'chd', 'frd', 'frd'),
	('36', 'frd', 'par', 'frd', 'frd'),
...
-- Hospitals
--
REPLACE INTO `hospital` (`idHospital`, `Title`, `Type`, `Status`)
values
...
VALUES
	...
	(21, 'ws_gen.php', 0, '', '', 0, 'a', '', '', 's'),
	(31, 'index.php', 0, '', '', 0, 'h', '', '', 'p'),
	(
		32,
		'_directory.php',
		2,
	...
	(46, 'guestadmin', 0, '', '', 0, 'h', '', '', 'c'),
	(47, 'guestaccess', 0, '', '', 0, 'v', '', '', 'c'),
	(
		49,
		'recent.php',
		2,
	...
	(75, 'ws_resv.php', 0, '', '', 0, 'h', '', '', 's'),
	(76, 'ws_ckin.php', 0, '', '', 0, 'h', '', '', 's'),
	(
		79,
		'_register.php',
		31,
...
REPLACE INTO `page_securitygroup` (`idPage`, `Group_Code`)
VALUES
	(1, 'pub'),
	(2, 'pub'),
	(3, 'mm'),
...
--
REPLACE INTO `language` (`idLanguage`, `Title`, `ISO_639_1`, `Display`)
VALUES
	(1, 'Abkhazian', 'ab', 0),
	(2, 'Afar', 'aa', 0),
	(3, 'Afrikaans', 'af', 0),
	...
	(43, 'Belarusian', 'be', 0),
	(45, 'Bengali', 'bn', 0),
	(48, 'Bihari languages', 'bh', 0),
	(52, 'Bislama', 'bi', 0),
	(57, 'Bokm̴l, Norwegian', 'nb', 0),
	(58, 'Bosnian', 'bs', 0),
	(60, 'Breton', 'br', 0),
	(62, 'Bulgarian', 'bg', 0),
	(64, 'Burmese', 'my', 0),
	...
	(82, 'Chinese', 'zh', 0),
	(86, 'Chuang', 'za', 0),
	(87, 'Church Slavic', 'cu', 0),
	(88, 'Church Slavonic', 'cu', 0),
	(90, 'Chuvash', 'cv', 0),
	(96, 'Cornish', 'kw', 0),
	(97, 'Corsican', 'co', 0),
	(98, 'Cree', 'cr', 0),
	...
	(164, 'German', 'de', 0),
	(169, 'Gikuyu', 'ki', 0),
	(176, 'Greek, Modern (1453-)', 'el', 0),
	(177, 'Greenlandic', 'kl', 0),
	(178, 'Guarani', 'gn', 0),
	(179, 'Gujarati', 'gu', 0),
	(182, 'Haitian', 'ht', 0),
	(183, 'Haitian Creole', 'ht', 0),
	(184, 'Hausa', 'ha', 0),
	(186, 'Hebrew', 'he', 0),
	(187, 'Herero', 'hz', 0),
	(190, 'Hindi', 'hi', 0),
	...
	(218, 'Japanese', 'ja', 0),
	(219, 'Javanese', 'jv', 0),
	(226, 'Kalaallisut', 'kl', 0),
	(229, 'Kannada', 'kn', 0),
	(230, 'Kanuri', 'kr', 0),
	(236, 'Kashmiri', 'ks', 0),
	(239, 'Kazakh', 'kk', 0),
	(243, 'Kikuyu', 'ki', 0),
	(245, 'Kinyarwanda', 'rw', 0),
	(247, 'Kirghiz', 'ky', 0),
	(250, 'Komi', 'kv', 0),
	(251, 'Kongo', 'kg', 0),
	(253, 'Korean', 'ko', 0),
	...
	(269, 'Latin', 'la', 0),
	(270, 'Latvian', 'lv', 0),
	(272, 'Letzeburgesch', 'lb', 0),
	(274, 'Limburgan', 'li', 0),
	(275, 'Limburger', 'li', 0),
	(276, 'Limburgish', 'li', 0),
	(277, 'Lingala', 'ln', 0),
	(278, 'Lithuanian', 'lt', 0),
	(284, 'Luba-Katanga', 'lu', 0),
	(291, 'Luxembourgish', 'lb', 0),
	(293, 'Macedonian', 'mk', 0),
	(298, 'Malagasy', 'mg', 0),
	(299, 'Malay', 'ms', 0),
	(300, 'Malayalam', 'ml', 0),
	...
	(337, 'Navaho', 'nv', 0),
	(338, 'Navajo', 'nv', 0),
	(339, 'Ndebele, North', 'nd', 0),
	(340, 'Ndebele, South', 'nr', 0),
	(341, 'Ndonga', 'ng', 0),
	(344, 'Nepali', 'ne', 0),
	(354, 'North Ndebele', 'nd', 0),
	(356, 'Northern Sami', 'se', 0),
	(358, 'Norwegian', 'no', 0),
	(359, 'Norwegian Bokm̴l', 'nb', 0),
	(360, 'Norwegian Nynorsk', 'nn', 0),
	(363, 'Nuosu', 'ii', 0),
	(365, 'Nyanja', 'ny', 0),
	(367, 'Nynorsk, Norwegian', 'nn', 0),
	(370, 'Occidental', 'ie', 0),
	(371, 'Occitan (post 1500)', 'oc', 0),
	(375, 'Ojibwa', 'oj', 0),
	(376, 'Old Bulgarian', 'cu', 0),
	(377, 'Old Church Slavonic', 'cu', 0),
	(379, 'Old Slavonic', 'cu', 0),
	(380, 'Oriya', 'or', 0),
	(381, 'Oromo', 'om', 0),
	(383, 'Ossetian', 'os', 0),
	(384, 'Ossetic', 'os', 0),
	...
	(454, 'Slovenian', 'sl', 0),
	(456, 'Somali', 'so', 0),
	(461, 'Sotho, Southern', 'st', 0),
	(463, 'South Ndebele', 'nr', 0),
	(466, 'Spanish', 'es', 1),
	(471, 'Sundanese', 'su', 0),
	(473, 'Swahili', 'sw', 0),
	(474, 'Swati', 'ss', 0),
...
VALUES
	...
	('BELIZE', 'BZ', 23),
	('CANADA', 'CA', 2),
	('COCOS (KEELING) ISLANDS', 'CC', 46),
	('CONGO, THE DEMOCRATIC REPUBLIC OF THE', 'CD', 49),
	('CENTRAL AFRICAN REPUBLIC', 'CF', 41),
	('CONGO', 'CG', 0),
	('SWITZERLAND', 'CH', 206),
	('COTE D\'IVOIRE', 'CI', 106),
	('COOK ISLANDS', 'CK', 50),
	('CHILE', 'CL', 43),
	('CAMEROON', 'CM', 38),
	('CHINA', 'CN', 44),
	...
	('ESTONIA', 'EE', 66),
	('EGYPT', 'EG', 62),
	('WESTERN SAHARA', 'EH', 235),
	('ERITREA', 'ER', 65),
	('SPAIN', 'ES', 199),
	('ETHIOPIA', 'ET', 67),
	('FINLAND', 'FI', 71),
	('FIJI', 'FJ', 70),
	('FALKLAND ISLANDS (MALVINAS)', 'FK', 68),
	('MICRONESIA, FEDERATED STATES OF', 'FM', 138),
	('FAROE ISLANDS', 'FO', 69),
	('FRANCE', 'FR', 73),
	('GABON', 'GA', 77),
	('UNITED KINGDOM', 'GB', 224),
	('GRENADA', 'GD', 86),
	('GEORGIA', 'GE', 79),
	('FRENCH GUIANA', 'GF', 75),
	('GUERNSEY', 'GG', 0),
	...
	('GUYANA', 'GY', 92),
	('HONG KONG', 'HK', 96),
	('HEARD ISLAND AND MCDONALD ISLANDS', 'HM', 94),
	('HONDURAS', 'HN', 95),
	('CROATIA', 'HR', 52),
	('HAITI', 'HT', 93),
	('HUNGARY', 'HU', 97),
	...
	('ISLE OF MAN', 'IM', 0),
	('INDIA', 'IN', 99),
	('BRITISH INDIAN OCEAN TERRITORY', 'IO', 32),
	('IRAQ', 'IQ', 102),
	('IRAN, ISLAMIC REPUBLIC OF', 'IR', 101),
	('ICELAND', 'IS', 98),
	('ITALY', 'IT', 105),
	('JERSEY', 'JE', 0),
	('JAMAICA', 'JM', 107),
	...
	('KIRIBATI', 'KI', 112),
	('COMOROS', 'KM', 48),
	('SAINT KITTS AND NEVIS', 'KN', 181),
	(
		'KOREA, DEMOCRATIC PEOPLE\'S REPUBLIC OF',
		'KP',
		0
	),
	('KOREA, REPUBLIC OF', 'KR', 198),
	('KUWAIT', 'KW', 113),
	('CAYMAN ISLANDS', 'KY', 40),
	('KAZAKHSTAN', 'KZ', 110),
	('LAO PEOPLE\'S DEMOCRATIC REPUBLIC', 'LA', 115),
	('LEBANON', 'LB', 117),
	('SAINT LUCIA', 'LC', 182),
	('LIECHTENSTEIN', 'LI', 121),
	('SRI LANKA', 'LK', 200),
	('LIBERIA', 'LR', 119),
	('LESOTHO', 'LS', 118),
	('LITHUANIA', 'LT', 122),
	...
	('MOROCCO', 'MA', 143),
	('MONACO', 'MC', 140),
	('MOLDOVA, REPUBLIC OF', 'MD', 139),
	('MONTENEGRO', 'ME', 0),
	('SAINT MARTIN (FRENCH PART)', 'MF', 0),
	('MADAGASCAR', 'MG', 126),
	('MARSHALL ISLANDS', 'MH', 132),
	(
	...
	('MONGOLIA', 'MN', 141),
	('MACAO', 'MO', 124),
	('NORTHERN MARIANA ISLANDS', 'MP', 159),
	('MARTINIQUE', 'MQ', 133),
	('MAURITANIA', 'MR', 134),
	('MONTSERRAT', 'MS', 142),
	('MALTA', 'MT', 131),
	...
	('MOZAMBIQUE', 'MZ', 144),
	('NAMIBIA', 'NA', 146),
	('NEW CALEDONIA', 'NC', 151),
	('NIGER', 'NE', 154),
	('NORFOLK ISLAND', 'NF', 157),
	('NIGERIA', 'NG', 155),
	('NICARAGUA', 'NI', 153),
	('NETHERLANDS', 'NL', 149),
	('NORWAY', 'NO', 160),
	...
	('PANAMA', 'PA', 164),
	('PERU', 'PE', 167),
	('FRENCH POLYNESIA', 'PF', 171),
	('PAPUA NEW GUINEA', 'PG', 165),
	('PHILIPPINES', 'PH', 168),
	('PAKISTAN', 'PK', 162),
	('POLAND', 'PL', 170),
	('SAINT PIERRE AND MIQUELON', 'PM', 183),
	('PITCAIRN', 'PN', 169),
	('PUERTO RICO', 'PR', 173),
	...
	('SURINAME', 'SR', 202),
	('SOUTH SUDAN', 'SS', 243),
	('SAO TOME AND PRINCIPE', 'ST', 184),
	('EL SALVADOR', 'SV', 63),
	('SINT MAARTEN (DUTCH PART)', 'SX', 245),
	('SYRIAN ARAB REPUBLIC', 'SY', 207),
	('SWAZILAND', 'SZ', 204),
	('TURKS AND CAICOS ISLANDS', 'TC', 219),
	('CHAD', 'TD', 42),
	('FRENCH SOUTHERN TERRITORIES', 'TF', 76),
	('TOGO', 'TG', 212),
	('THAILAND', 'TH', 211),
	('TAJIKISTAN', 'TJ', 208),
	('TOKELAU', 'TK', 213),
	...
	('TONGA', 'TO', 214),
	('TURKEY', 'TR', 217),
	('TRINIDAD AND TOBAGO', 'TT', 215),
	('TUVALU', 'TV', 220),
	('TAIWAN, PROVINCE OF CHINA', 'TW', 209),
	('TANZANIA, UNITED REPUBLIC OF', 'TZ', 210),
	('UKRAINE', 'UA', 222),
	('UGANDA', 'UG', 221),
	('UNITED STATES MINOR OUTLYING ISLANDS', 'UM', 226),
	('UNITED STATES', 'US', 1),
	('URUGUAY', 'UY', 225),
	('UZBEKISTAN', 'UZ', 227),
	('HOLY SEE (VATICAN CITY STATE)', 'VA', 229),
	('SAINT VINCENT AND THE GRENADINES', 'VC', 185),
	('VENEZUELA, BOLIVARIAN REPUBLIC OF', 'VE', 230),
	('VIRGIN ISLANDS, BRITISH', 'VG', 232),
	('VIRGIN ISLANDS, U.S.', 'VI', 233),
	('VIET NAM', 'VN', 231),
	('VANUATU', 'VU', 228),
	('WALLIS AND FUTUNA', 'WF', 234),
	('SAMOA', 'WS', 186),
	('YEMEN', 'YE', 236),
	('MAYOTTE', 'YT', 136),
	('SOUTH AFRICA', 'ZA', 197),
