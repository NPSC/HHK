...
function amtPaid() {
    ...
    // Charges
    totRmBalDue = roundTo(a.roomBalDue + a.roomBalTaxDue, 2);
    a.totCharges = a.invCharge + a.visitfeeCharge + a.kdepCharge + totRmBalDue - a.totReturns;

    // Payments
    a.totPay = a.invAmt + a.vfee + a.kdep + a.feePay - a.totReturns;
