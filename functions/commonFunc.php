...
function showGuestPicture ($idGuest, $widthPx) {
    ...
    return
    	...
    	HTMLContainer::generateMarkup('input', '', array('id'=>'guestPhotoInput', 'type'=>'hidden')) . 
        ...
        , array("class"=>"ui-button ui-corner-all ui-widget", 'style'=>'padding: .3em; margin-right:0.3em;', "id"=>"addGuestPhoto")) . HTMLContainer::generateMarkup('button',
